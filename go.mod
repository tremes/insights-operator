...
replace (
	github.com/openshift/api => github.com/openshift/api v0.0.0-20201123164755-d8862a308f98
	github.com/openshift/client-go => github.com/openshift/client-go v0.0.0-20201123133249-10558821f936
